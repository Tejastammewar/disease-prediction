...
def predict():
    col=['itching', 'nodal_skin_eruptions', 'chills', 'joint_pain', 'vomiting',
       'spotting_ urination', 'fatigue', 'weight_loss', 'lethargy',
       'high_fever', 'sunken_eyes', 'breathlessness', 'sweating', 'headache',
       'yellowish_skin', 'dark_urine', 'nausea', 'pain_behind_the_eyes',
       'back_pain', 'constipation', 'abdominal_pain', 'diarrhoea',
       'mild_fever', 'yellowing_of_eyes', 'malaise', 'phlegm', 'congestion',
       'chest_pain', 'fast_heart_rate', 'irritation_in_anus',
       'puffy_face_and_eyes', 'excessive_hunger', 'muscle_weakness',
       'stiff_neck', 'unsteadiness', 'bladder_discomfort', 'passage_of_gases',
